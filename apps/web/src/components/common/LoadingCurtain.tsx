...
export default function LoadingCurtain() {
    ...
    const textMoveVariants: Variants = {
        moveUp: {
            y: "-15vh",
            scale: 0.85,
    ...
    return (
        <div className={`relative w-full h-screen overflow-hidden bg-[#525d5f] `}>
            ...
            >
                ...
                <div className="flex flex-col items-center text-sm md:text-base tracking-widest font-light opacity-90 mt-auto border-t border-white/30 pt-4">
                    <p>Archive</p>
                    <p className={"pointer-events-auto z-[100] underline text-blue-500 hover:text-blue-600 hover:cursor-pointer flex items-center justify-center gap-4"}>
